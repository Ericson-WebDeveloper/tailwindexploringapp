                        ...
                        <div class="bg-white p-3 shadow-sm rounded-sm">
                            ...
                            <div class="grid grid-cols-2">
                                <div>
                                    ...
                                    <button @click.prevent="EditJobExp()"
                                class="block w-full text-blue-800 text-sm font-semibold rounded-lg hover:bg-gray-100 focus:outline-none focus:shadow-outline 
                                focus:bg-gray-100 hover:shadow-xs p-3 my-4">
                                Edit Job Exp. Data</button>
                                </div>
                                <div>
                                    <div class="flex items-center space-x-2 font-semibold text-gray-900 leading-8 mb-3">
                                        <span clas="text-green-500">
...
export default {
    setup() {
        ...
        return {
            profileEdit, editProfile, jobExpEdit, EditJobExp
        }
    }
}
</script>
