                ...
                <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                        ...
                        <div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
                            <div class="p-4 md:p-12 text-center lg:text-left">
                                ...
                                <div @click="imageEdit = !imageEdit" class="block lg:hidden rounded-full shadow-xl mx-auto -mt-16 h-48 w-48 bg-cover bg-center cursor-pointer" 
                                ...
                                <div class="pt-12 pb-8 space-x-2 space-y-2">
                                    ...
                                    <button @click="jobExpView = !jobExpView" class="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
                                        View Job Exp:
                                    </button> 
                    ...
                    <div class="m-auto">
                        <div>
                            ...
                            <div class="mt-2 bg-white rounded-lg shadow">
                                ...
                                <div class="px-5 pb-5">
                                    <input  placeholder="Password" type="password" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                    <input  placeholder="Confirm Password" type="password" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                    ...
                    <div class="m-auto">
                        <div>
                            ...
                            <div class="mt-2 bg-white rounded-lg shadow">
                                ...
                                <div class="px-5 pb-5">
                                    <input placeholder="Image" type="file" class=" text-black placeholder-gray-600 w-full px-4 py-2.5 mt-2 text-base   transition duration-500 ease-in-out transform border-transparent rounded-lg bg-gray-200  focus:border-blueGray-500 focus:bg-white dark:focus:bg-gray-800 focus:outline-none focus:shadow-outline focus:ring-2 ring-offset-current ring-offset-2 ring-gray-400">
                                </div>
                            </div>
...
export default {
    setup() {
        ...
        return {
            profileView, jobExpView, profileEdit, jobExpEdit, passwordEdit, imageEdit
        }
    }
}
</script>